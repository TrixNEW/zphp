...
pub const map = std.StaticStringMap([]const []const u8).initComptime(.{
    ...
    .{ "Zphp\\Channel::__construct", &.{"$capacity"} },
    .{ "Zphp\\Channel::send", &.{ "$value", "$timeout" } },
    .{ "Zphp\\Channel::trySend", &.{"$value"} },
    .{ "Zphp\\Channel::recv", &.{"$timeout"} },
    .{ "Zphp\\select", &.{ "$sources", "$timeout" } },
    .{ "Zphp\\Buffer::__construct", &.{"$length"} },
    .{ "Zphp\\Buffer::fromString", &.{"$bytes"} },
    .{ "Zphp\\Buffer::slice", &.{ "$offset", "$length" } },
    .{ "Zphp\\Buffer::write", &.{ "$offset", "$data" } },
    .{ "Zphp\\Buffer::readFrom", &.{"$stream"} },
    .{ "Zphp\\Buffer::writeTo", &.{"$stream"} },
    .{ "Zphp\\Buffer::readInt8", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeInt8", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readUInt8", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeUInt8", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readInt16LE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeInt16LE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readInt16BE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeInt16BE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readUInt16LE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeUInt16LE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readUInt16BE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeUInt16BE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readInt32LE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeInt32LE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readInt32BE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeInt32BE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readUInt32LE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeUInt32LE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readUInt32BE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeUInt32BE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readInt64LE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeInt64LE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readInt64BE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeInt64BE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readFloat32LE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeFloat32LE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readFloat32BE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeFloat32BE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readFloat64LE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeFloat64LE", &.{ "$offset", "$value" } },
    .{ "Zphp\\Buffer::readFloat64BE", &.{"$offset"} },
    .{ "Zphp\\Buffer::writeFloat64BE", &.{ "$offset", "$value" } },
