...
pub const names = [_][]const u8{
    ...
    "GlobIterator", "SplStack", "SplQueue", "SplDoublyLinkedList", "SplFixedArray",
    "SplObjectStorage", "SplPriorityQueue", "SplMinHeap", "SplMaxHeap", "SplHeap",
    ...
    "ReflectionExtension", "ReflectionZendExtension", "Reflector", "ReflectionConstant",
    ...
    "MessageFormatter", "Locale", "Phar", "PharData", "SoapClient", "SoapServer",
    "SoapFault", "GdImage", "OpenSSLAsymmetricKey", "OpenSSLCertificate",
