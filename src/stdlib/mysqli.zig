...
const mysql = struct {
    ...
    extern "c" fn mysql_sqlstate(m: *MYSQL) callconv(.c) [*:0]const u8;
    extern "c" fn mysql_errno(m: *MYSQL) callconv(.c) c_uint;
    ...
    extern "c" fn mysql_select_db(m: *MYSQL, db: [*:0]const u8) callconv(.c) c_int;
    extern "c" fn mysql_options(m: *MYSQL, option: c_int, arg: ?*const anyopaque) callconv(.c) c_int;
    // MYSQL_SET_CHARSET_NAME enum value in mysql.h is 7
    const MYSQL_SET_CHARSET_NAME: c_int = 7;
    extern "c" fn mysql_character_set_name(m: *MYSQL) callconv(.c) [*:0]const u8;
    extern "c" fn mysql_get_client_info() callconv(.c) [*:0]const u8;
    extern "c" fn mysql_get_client_version() callconv(.c) c_ulong;
    extern "c" fn mysql_get_server_info(m: *MYSQL) callconv(.c) [*:0]const u8;
    extern "c" fn mysql_get_server_version(m: *MYSQL) callconv(.c) c_ulong;
    extern "c" fn mysql_get_host_info(m: *MYSQL) callconv(.c) [*:0]const u8;
    extern "c" fn mysql_thread_id(m: *MYSQL) callconv(.c) c_ulong;
    extern "c" fn mysql_ping(m: *MYSQL) callconv(.c) c_int;
};
