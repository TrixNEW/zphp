...
// other calls that hand the path to the os fail the way the os does
...
var_dump(@scandir("nope/../real"), @opendir("nope/../real"), realpath("nope/../real"));
...
foreach (['f.txt', 'g.txt', 'i.php', 'c.ini', 'copied.txt'] as $name) @unlink("$base/real/$name");
rmdir("$base/real");
