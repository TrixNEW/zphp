...
// and buffer payloads in both directions leave the process footprint where it was
...
for ($i = 0; $i < 200; $i++) { $pool->submit('buffer_make', [65536])->await(); $pool->submit('buffer_sum', [new Zphp\Buffer(4096)])->await(); }
